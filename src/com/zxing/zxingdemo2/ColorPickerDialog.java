...
public class ColorPickerDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		int width = (int) (manager.getDefaultDisplay().getWidth() * 0.75f);
	...
	private class ColorPickerView extends View {
		...
		private boolean downInCircle = true;// 按在渐变色环上
		private boolean downInRect;// 按在渐变色块上
		...
		public ColorPickerView(Context context, int height, int width) {
			...
			rectTop = r + mPaint.getStrokeWidth() * 0.5f
					+ mLinePaint.getStrokeWidth() * 0.5f + 15;
	...
	public OnColorChangeListener getmListener() {
		return mListener;
	}

	public void setmListener(OnColorChangeListener mListener) {
